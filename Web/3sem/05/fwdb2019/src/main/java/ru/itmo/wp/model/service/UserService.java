...
public class UserService {
    ...
    public void validateRegistration(User user, String email, String password, String confirm) throws ValidationException {
        ...
        if (!password.equals(confirm)) {
            throw new ValidationException("Password and confirm aren't equals");
        }
    }
    ...
    public User validateAndFindByLoginAndPassword(String login, String password) throws ValidationException {
        User user = userRepository.findByXAndPasswordSha(login, getPasswordSha(password));
        if (user == null) {
            throw new ValidationException("Invalid X or password");
        }
        return user;
    }
